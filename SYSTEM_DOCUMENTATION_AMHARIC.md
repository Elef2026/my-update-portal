...
### የትዕዛዝ አይነቶች (Order Types)
1. **አፕዴት ብቻ (UPDATE_ONLY):**
   * ደንበኛው የዲጂታል ሰነድ ማሻሻያ/አፕዴት ብቻ የሚፈልግ ሲሆን፤ አድሚኑ ሰርቶ ሲያጠናቅቅ ፋይሉ በቀጥታ ለተጠቃሚው ይላካል (ወደ ህትመት መሄድ አያስፈልገውም)።
2. **ሙሉ አገልግሎት (FULL_SERVICE - አፕዴት + ህትመት):**
   * ደንበኛው ሰነዱ እንዲታደስ እና ታትሞ በህትመት ቤቱ በኩል እንዲሰጠው ይደረጋል።
...
## 2. የህትመት ቤቶች መመሪያ (Print Shop User Guide)
