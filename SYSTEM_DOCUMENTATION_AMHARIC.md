...
1. **በቻፓ (CHAPA Online Payment Gateway):**
   * ደንበኛው ወይም ህትመት ቤቱ በ **ቴሌብር (Telebirr)**፣ **ሲቢኢ ብር (CBE Birr)**፣ **አዋሽ ብር (Awash Birr)** ወይም **በባንክ ካርድ (Visa/Mastercard)** በቀጥታ በቻፓ ቼክአውት ይከፍላል።
   * ክፍያው እንደተፈጸመ ሲስተሙ ወዲያውኑ አረጋግጦ ትዕዛዙን **PAID** ያደርገዋል፤ የ SMS ማረጋገጫ ለደንበኛው ይልካል፤ አድሚኑም ስራውን ወዲያውኑ መስራት ይጀምራል።
   * **ከእርስዎ የሚፈለግ ዝግጅት:**
     * በ [https://dashboard.chapa.co](https://dashboard.chapa.co) አካውንት መክፈት።
     * በ `.env` ፋይል ውስጥ የቻፓ Secret Key (`CHAPA_SECRET_KEY`) ማስገባት።
